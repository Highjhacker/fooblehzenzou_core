...
git clone "https://github.com/Highjhacker/fooblehzenzou_core" "$HOME/core-token" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/Highjhacker/fooblehzenzou_core'"
    exit 1
fi
...
rm -rf "$HOME/.config/@fooblehzenzou"
